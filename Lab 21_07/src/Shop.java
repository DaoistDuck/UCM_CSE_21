...
public class Shop {
	...
	private double calcSubTotal() {
		double subTotal = 0;
		subTotal += (Sharp.getAmount() * Sharp.getPrice()) + (Brie.getAmount() * Brie.getPrice()) + (Swiss.getAmount() * Swiss.getPrice());
		// Fill-in Code
	...
	private void itemizedList(){
		...
		if ((amt = Sharp.getAmount()) > 0) 
			System.out.println(amt + " lbs of Sharp  @ $1.25  = " + (amt * Sharp.getPrice()));
